...
Public Class DB
    ...
    Public Function CheckPrevTests(ByRef UUT As Hashtable) As Boolean
        ...
        End If
        If Not Passed Then
            _ErrorMsg = "Passing result for controller board test not found, SN=" + ControllerBoardSN
            Return False
        End If
        ...
        End If
        If Not Passed Then
            _ErrorMsg = "LEAK test passing results not seen"
            Return False
        End If
